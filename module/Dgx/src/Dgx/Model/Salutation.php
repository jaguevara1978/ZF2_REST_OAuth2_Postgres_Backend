...
class Salutation extends BaseModel
{
    ...
    protected $salutation_label = null;

    protected $full_label = null;

    protected $total_entries = null;

    public function exchangeArray($data)
    {
        $this->salutation_label = ( isset( $data[ 'salutation_label' ] ) ) ? $data[ 'salutation_label' ] : null;
        $this->full_label = ( isset( $data[ 'full_label' ] ) ) ? $data[ 'full_label' ] : null;
